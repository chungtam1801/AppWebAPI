...
namespace AppView.Controllers
{
    public class ThuocTinhController : Controller
    {
       ...
       private AssignmentDBContext dbContext =new AssignmentDBContext();
        ...
        [HttpPost]
        public async Task<IActionResult> Update(ThuocTinh thuoctinh)
        {repos.Update(thuoctinh);
            return RedirectToAction("GetAllThuocTinh");

            //var url =
            //    $"https://localhost:7021/api/ThuocTinh/Update-ThuocTinh?id=1dbb9c00-2858-4932-932f-97d1c1661e28&ten={thuoctinh.Ten}&ngaytao={thuoctinh.NgayTao}&trangthai={thuoctinh.TrangThai}";
